...
import type { OpenCodeConnectionConfig } from "@/api/providers/types";
...
export function clearClientCache(
  config?: OpenCodeConnectionConfig | ConnectionConfig,
): void {
  if (!config) {
    clientCache.clear();
    return;
  ...
  const prefix = getClientCacheKey(config as OpenCodeConnectionConfig);
